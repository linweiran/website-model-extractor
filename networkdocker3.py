		...
		try:
			...
			try:	
				...
				for website in sites:
					...
					imagecommand="docker run --rm --name "+website+"-caddy.ttat.xyz --net "+website+" -v "+os.path.abspath(".")+"/"+Caddypath+"/"+website+"-Caddyfile:/etc/Caddyfile -v /home/nikita/caddy/ttat.xyz:/certs -v "+os.path.abspath(".")+"/"+httppath+"/"+website+":/srv abiosoft/caddy --conf=/etc/Caddyfile -http2=false"
